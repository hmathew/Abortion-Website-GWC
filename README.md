...
├── portfolio.html    # "Take Action" page with more information and visuals
...
- Includes a fact generator section
- Uses a button to display new facts dynamically

### portfolio.html
- Displays the "Take Action" page
- Includes an image and supporting text
- Provides additional educational information about abortion

### script.js
- Stores facts in an array
- Updates the displayed fact each time the button is clicked
- Loops back to the beginning after all facts are shown

### style.css
- Styles text, background colors, and images
- Designs the navigation bar and hover effects
- Formats the fact generator and content layout
...
4. Click the button to generate facts and explore the site
